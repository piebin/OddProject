    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (hit.collider != null && gamePlay)
            {
                ...
                if (hit.collider.gameObject==saucesB[0] && IsclickedDduk < 0 && !spSauceP.activeSelf)//보라
                {
                ...
                if (hit.collider.gameObject == saucesB[1] && IsclickedDduk < 0 && !spSaucePK.activeSelf)//분홍
                {
                ...
                if (hit.collider.gameObject == saucesB[2] && IsclickedDduk < 0 && !spSauceB.activeSelf)//파랑
                {
                ...
                if (hit.collider.gameObject == saucesB[3] && IsclickedDduk < 0 && !spSauceG.activeSelf)//초록
                {
